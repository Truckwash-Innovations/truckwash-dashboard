 ...
 *
 *  Dit bestand is gelijk aan dat van de kassa, op de naam van de repository
 *  na. Wijzig je hier iets, wijzig het daar ook -- of haal het over met
 *  scripts/kern-bijwerken.cjs in de kassa-repo.
 *
