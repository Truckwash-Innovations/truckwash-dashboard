...
const TABLE_OF: Record<EntityName, () => any> = {
  ...
  expenseGebeurtenissen: () => db.expenseGebeurtenissen,
  expenseRegels: () => db.expenseRegels,
  documents: () => db.documents,
  mailbox: () => db.mailbox,
  werkmail: () => db.werkmail,
  postbussen: () => db.postbussen,
  postbusLeden: () => db.postbusLeden,
  werkmailMappen: () => db.werkmailMappen,
